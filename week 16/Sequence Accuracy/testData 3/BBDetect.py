...
for bagSize in range(2, 20):
    ...
    for m in range(1, 21):
        ...
        for n in range(m+1,21):
            ...
            MaliciousData = np.loadtxt('benign_'+str(n)+'.txt', dtype='str', delimiter='\n')
            ...
            if matchCount / len(MalseqFreqMap) >= 0.7:
                benignTrue += 1
                # print("Benign")
...
for bagSize in range(2, 20):
    ...
    for m in range(1, 21):
        ...
        for n in range(1,21):
            ...
            MaliciousData = np.loadtxt('malicious_'+str(n)+'.txt', dtype='str', delimiter='\n')
